    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: isActive ? AppColors.primary.withValues(alpha: 0.30) : AppColors.border),
          boxShadow: isActive ? [BoxShadow(color: AppColors.primary.withValues(alpha: 0.12), blurRadius: 20)] : [],
        ),
        child: Column(
          children: [
            // ── Gradient top bar ─────────────────────────────
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: (isActive ? AppColors.primary : AppColors.faint).withValues(alpha: 0.12),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(ticket.eventoNombre ?? 'Ticket ${ticket.tipo}',
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: DecoratedBox(
                                        ...
                                        child: ElevatedButton(
                                          onPressed: isActive ? widget.onUse : null,
                                  ...
                                  Expanded(
                                    child: SizedBox(
                                      ...
                                      child: OutlinedButton(
                                        onPressed: isActive ? widget.onCancel : null,
                                        style: OutlinedButton.styleFrom(
                                          side: BorderSide(color: isActive ? const Color(0xFFFF5C5C).withValues(alpha: 0.50) : AppColors.border),
